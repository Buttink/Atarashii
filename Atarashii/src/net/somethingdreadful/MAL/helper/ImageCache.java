 ...
 */
package net.somethingdreadful.MAL.helper;
...
public class ImageCache {
	...
	private static final String cacheFolder = "images";
	...
	{
		singleton = new ImageCache( c.getApplicationContext() );
	}
	
	public static ImageCache getSingleton( Context c ) {
		if ( singleton == null ) {
			newSingleton(c);
		}
		return singleton;
